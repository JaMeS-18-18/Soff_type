...
async function showResult() {
  ...
  //     data: {
  //       "wpm": stats.wpm,
  //       "wpm_30": AllUsers[UserID].wpm_30,
  //       "group": AllUsers[UserID].group,
  //       "name": AllUsers[UserID].name,
  //       "password": AllUsers[UserID].password,
  //       "id": UserID
  //     },
  //     success: (res) => {
  //       localStorage.setItem("ThisUser", JSON.stringify(AllUsers[UserID]))
  //     },
  //     error: (err) => {
